...
public class MainActivityFragment extends Fragment implements IconSelectDialog.OnIconSelectedListener,
    ...
    private static ArrayList<SelectableIcon> sampleIcons() {
        ...
        selectionDialogsColors.add(new SelectableIcon("1", "一年级", R.drawable.sample_icon_bookmark));
        selectionDialogsColors.add(new SelectableIcon("2", "二年级", R.drawable.sample_icon_bookmark));
        selectionDialogsColors.add(new SelectableIcon("3", "三年级", R.drawable.sample_icon_bookmark));
        selectionDialogsColors.add(new SelectableIcon("4", "四年级", R.drawable.sample_icon_bookmark));
        selectionDialogsColors.add(new SelectableIcon("5", "五年级", R.drawable.sample_icon_bookmark));
        selectionDialogsColors.add(new SelectableIcon("6", "六年级", R.drawable.sample_icon_bookmark));
        selectionDialogsColors.add(new SelectableIcon("7", "七年级", R.drawable.sample_icon_bookmark));
